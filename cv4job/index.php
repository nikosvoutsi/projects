    ...
    <div id="form">
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if(!empty($errors)){
                ...
                }print "<br><br><p style='color:red; font-size:large';>Ο συνδυασμός email και password δεν είναι αποδεκτός!<br><br></p>\n";
            }}}}
    
            ?>
<h3>Sign in to your account</h3><br>
<form action="" method="post" enctype="multipart/form-data">
<p><input type="email" name="email" maxsize="100" placeholder="Email" style='font-size: 13pt; height: 40px; width:280px; text-align:center; background-color:rgb(236, 234, 234)'><br></p>
<p><input type="password" name="password" id="password" maxsize="100" placeholder="Password" style='font-size: 13pt; height: 40px; width:280px; text-align:center; background-color:rgb(236, 234, 234)'><br><br></p>
<p><input type="submit" name="submit" value="Sign in" style="font-size:18px; height: 70px; width:160px; text-align:center;"></p><br>
<p style="color:black">Forgot your <a href="forgot.php" style="color:blue">password</a></p>
