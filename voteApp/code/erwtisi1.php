...
?>
    ...
    $query0="select erwtisi from erwtiseis where id=1";
    ...
    if($r0){
        ...
        <div id='container' style='opacity:0.9'>
        <div id='header'><h2 style='color:red'>Eρώτηση 1η</h2></div>
           <h2>$erwtisi</h2>
           <a  href='erwtisi2.php?q=1' style='color:green; font-size:23px;'><div id='epilogi'><p id='ep2'>Συμφωνω</p></div></a>
           <a  href='erwtisi2.php?q=2' style='color:rgb(66, 61, 61);'><div id='epilogi'><p id='ep'>Ουτε συμφωνω ουτε διαφωνω</p></div></a>
           <a  href='erwtisi2.php?q=3' style='color:red;'><div id='epilogi'><p id='ep2'>Διαφωνω</p></div></a><br>
        </div>
