             ...
             while(mysqli_stmt_fetch($stmt0)){
                ...
                if (mysqli_stmt_affected_rows($stmt)!=1){
                   print"<p style='color:red; font-size:x-large'>Σφάλμα συστήματος</p>\n";
                    ...
                    $query0="select erwtisi from erwtiseis where id=8";
                    $stmt0=mysqli_prepare($dbc, $query0);
                    $r0=mysqli_execute($stmt0);
                    if($r0){
                        mysqli_stmt_store_result($stmt0);
                        ...
                        if (my_mysqli_stmt_num_rows($stmt0) == 1) {
                           while(mysqli_stmt_fetch($stmt0)){
                                ...
                                <div id='container'>
                               <div id='header'><h2 style='color:red'>Eρώτηση 8η</h2></div>
                               <h2>$erwtisi</h2>
                               <a  href='erwtisi9.php?q=1' style='color:green;'><div id='epilogi'><p id='ep2'>Συμφωνω</p></div></a>
                               <a  href='erwtisi9.php?q=2' style='color:rgb(66, 61, 61);'><div id='epilogi'><p id='ep'>Ουτε συμφωνω ουτε διαφωνω</p></div></a>
                               <a  href='erwtisi9.php?q=3' style='color:red;'><div id='epilogi'><p id='ep2'>Διαφωνω</p></div></a><br>
                               </div>
