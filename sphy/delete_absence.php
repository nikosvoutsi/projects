...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $months=[1=>'Ιανουάριος', 2=>'Φεβρουάριος',3=>'Μάρτιος',4=>'Απρίλιος', 5=>'Μάϊος', 6=>'Ιούνιος', 7=>'Ιούλιος',
        ...
        print"<form action='delete_absence2.php' method='post'>";
        print"<p>ΑΜ:<br>
        ...
        <p>Aιτία απουσίας:<br>
        <input type='text' name='aitia' value='$reason' style='width:250px; text-align:center' required>       
<p>Ημέρα απουσίας: <br><input type='text' name='day' size='5' min='1' max='31' value='$date' style='width:250px; text-align:center' readonly></p>
...
<p>ΑΜ:<br>
<input type="text" name="id" maxsize="100" style="width:250px; text-align:center"><br>
