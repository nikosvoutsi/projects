  ...
  <div class="fadeIn first">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(!empty($errors)){
          ...
          print"<h1>Προσθέστε AM σπουδαστή για να δείτε το προφίλ</h1><br>
        ...
        $query = "select distinct s.id, s.rank, s.firstname, s.lastname, s.series
        from students  s where s.id=$am";
        ...
        if($r){
            ...
            if (my_mysqli_stmt_num_rows($stmt) == 1) {
              while(mysqli_stmt_fetch($stmt)){
                print"<form action='insert_user3.php' method='post'>";
        print"<p>ΑΜ:<br>
